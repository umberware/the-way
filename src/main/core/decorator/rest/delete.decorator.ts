...
/**
 *   @name Delete
 *   @description The @Delete is designed for
 *      [HTTP DELETE](https://developer.mozilla.org/pt-BR/docs/Web/HTTP/Methods/DELETE).
...
export const Delete = (path: string, authenticated?: boolean, allowedProfiles?: Array<any>) => {
    return (target:  any, propertyKey: string, descriptor: unknown): any => {
        CORE.registerRestPath(HttpTypeEnum.DELETE, path, target, propertyKey, authenticated, allowedProfiles);
        return descriptor;
    };
};
