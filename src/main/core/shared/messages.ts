export const MESSAGES: { [key: string]: { [key: string]: string | number; } } = {
    'en': {
        ...
        'building-class': 'Building instance: $',
        ...
        'cannot-override-twice': 'it is not possible to overwrite more than once. Was registered the overridden $ as $. The current is $.',
        ...
        'registering-dependency-class': 'Registered dependency between: $ into $',
        'registering-overridden-class': 'Registered overriden: $ as $',
